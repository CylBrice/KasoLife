...
const PSEUDO_ERROR_MSG  = 'Pseudonyme invalide — 3 à 20 caractères : lettres, chiffres et underscore (_) uniquement';
const PSEUDO_MAX_CHANGES = 5; // changements à vie pour les utilisateurs standard
...
module.exports = {
  ...
  PSEUDO_REGEX, PSEUDO_MIN_LENGTH, PSEUDO_MAX_LENGTH, PSEUDO_ERROR_MSG, PSEUDO_MAX_CHANGES,
